...
public class RockFall_MagicState : BaseState<PlayerStateType>
{
    ...
    public RockFall_MagicState(PlayerStateType key, StateManager<PlayerStateType> stateManager, PlayerInputManager inputManager, Transform playerTransform, MonoBehaviour monoBehaviour, Animator animator)
