...
public class Storm_MagicState : BaseState<PlayerStateType>
{
    ...
    private float skillRadius = 15f;     // 스킬 범위 반경
    private int lightningCount = 12;      // 낙뢰 개수
    private float lightningHeight = 0.2f; // 낙뢰가 떨어지는 높이
    private float minDistance = 7f;      // 낙뢰들 사이의 최소 거리
