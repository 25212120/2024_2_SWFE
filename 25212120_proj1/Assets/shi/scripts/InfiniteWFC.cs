...
namespace CustomNamespace
{
    ...
    public class Cell
    {
        ...
        public int Entropy => possibleTiles.Count; // 엔트로피 계산 (가능한 타일 수)
    }
    ...
    public class InfiniteWFC : MonoBehaviour
    {
        ...
        private Stack<Cell> backtrackStack = new Stack<Cell>(); // 백트랙 스택
        ...
        void Update()
        {
            UpdateCells(); // 플레이어가 움직일 때마다 셀 업데이트
        }
            ...
            List<MapTile> volcanoTiles = new List<MapTile>
{
    ...
    new MapTile("volcanoTile10", volcanoPrefab10, "Volcano", j2_1, j2_2, j2_4, j2_3)
            ...
            // 타일 세트를 초기화 (예제: Desert, Forest 등등의 타일 목록을 생성)
